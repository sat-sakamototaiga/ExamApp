<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        <x-nav-link :href="route('quiz.select_exam')" :active="request()->routeIs('quiz.select_exam') || request()->routeIs('quiz.*')">
                            試験開始
                        </x-nav-link>
                    @else
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @auth
                <x-responsive-nav-link :href="route('quiz.select_exam')" :active="request()->routeIs('quiz.select_exam') || request()->routeIs('quiz.*')">
                    試験開始
